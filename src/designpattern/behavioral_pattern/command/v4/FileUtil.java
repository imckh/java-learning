...
public class FileUtil {
    ...
    public static void writeCommands(List commands) {
        try {
            ...
            FileOutputStream file = new FileOutputStream("src\\\\designpattern\\\\behavioral_pattern\\\\command\\\\v4\\\\config.log");
            //创建对象输出流用于将对象写入到文件中
    ...
    public static ArrayList readCommands() {
        try {
            FileInputStream file = new FileInputStream("src\\\\designpattern\\\\behavioral_pattern\\\\command\\\\v4\\\\config.log");
            //创建对象输入流用于从文件中读取对象
